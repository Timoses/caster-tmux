...
from dragonfly import MappingRule, Key, Grammar, Key, Repeat, Choice, IntegerRef, Function
...
class Control(MappingRule):
    mapping = {
        ...
        "shackle":
            Key(JUMP_WALL["left"]) + Key(key_add_modifier(JUMP_WALL["right"], "s")),
        "<direction> [<n500>]":
...
# -> OS plugin?
#        "undo [<n10>]":
#            Key("c-z") * Repeat(extra="n10"),
#        "redo [<n10>]":
#            Key("c-y") * Repeat(extra="n10"),
