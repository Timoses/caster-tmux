from dragonfly import MappingRule, Key, Grammar, Key, Repeat, Choice, IntegerRef, Function, Text, get_current_engine
...
#            Function(navigation.previous_line),
        "[<long>] <text_punc> [<n>]":
            Text("%(long)s" + "%(text_punc)s" + "%(long)s") * Repeat(extra="n"),
        "<double_text_punc> [<n>]":
